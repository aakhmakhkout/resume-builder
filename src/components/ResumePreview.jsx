    ...
    <div className="preview-panel">
      <div className="preview-toolbar">
        ...
        <div className="preview-toolbar-actions">
          ...
          <button className="btn-preview" onClick={() => handlePreview(true)} disabled={!hasContent || pdfBusy}>
            👁 {pdfBusy ? 'Generating…' : 'Preview PDF'}
          </button>
          <div className="btn-download-group" ref={dlMenuRef}>
            <button className="btn-download" onClick={() => handleDownload(true)} disabled={!hasContent || pdfBusy}>
      ...
      {pdfError && <div className="pdf-error-banner">{pdfError}</div>}
