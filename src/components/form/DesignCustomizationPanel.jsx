...
const DESIGN_FIELDS = [
  ...
  },
  {
    title: 'Page',
    items: [
      { key: 'pageMarginTop', label: 'Page margin top', type: 'number', min: 0, max: 60, step: 1 },
      { key: 'pageMarginBottom', label: 'Page margin bottom', type: 'number', min: 0, max: 60, step: 1 },
      { key: 'pageMarginLeft', label: 'Page margin left', type: 'number', min: 0, max: 60, step: 1 },
      { key: 'pageMarginRight', label: 'Page margin right', type: 'number', min: 0, max: 60, step: 1 },
